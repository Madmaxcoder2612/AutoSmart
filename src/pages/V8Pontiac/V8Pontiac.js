                ...
                <div className="md:grid md:grid-cols-2 md:mr-15 mr-1 sm:mx-4">
                    ...
                    <div className="mt-5 md:mt-0 md:col-span-1">
                        <div className="md:flex md:flex-col md:justify-center ">
                            ...
                            <p className="self-center mx-8 text-xl font-medium tracking-wide text-justify text-white font- popins">The Pontiac V8 engine is a family of overhead valve 90° V8 engines manufactured by the Pontiac Division of General Motors Corporation between 1955 and 1981. The engine featured a cast iron block and head and 2 valves per cylinder. </p>
                            ...
                            <div className="grid justify-center grid-cols-1 gap-6 pb-8 mx-8 md:grid-cols-2 lg:grid-cols-2">
                                <img className="flex p-6 text-6xl rounded-xl h-64 w-64" src="https://storage.echoar.xyz/wispy-violet-4999/84fc9e27-d5ac-4c30-bb08-fc76f3c8686c" alt="QR" />
                                <a href="https://go.echoar.xyz/3Y2t" target="_blank" rel="noreferrer">
