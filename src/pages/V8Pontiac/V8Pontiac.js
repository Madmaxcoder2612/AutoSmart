                ...
                <div className="md:grid md:grid-cols-2 md:mr-15 mr-1 sm:mx-4">
                    ...
                    <div className="mt-5 md:mt-0 md:col-span-1">
                        <div className="md:flex md:flex-col md:justify-center ">
                            ...
                            <h2 className="self-center mx-8 mb-4 text-5xl font-medium tracking-wide text-white font-fontVollkorn">Pontiac V8 engine</h2>

                            <p className="self-center mx-8 text-xl font-medium tracking-wide text-justify text-white font-fontVollkorn">The Pontiac V8 engine is a family of overhead valve 90° V8 engines manufactured by the Pontiac Division of General Motors Corporation between 1955 and 1981. The engine featured a cast iron block and head and 2 valves per cylinder. </p>
