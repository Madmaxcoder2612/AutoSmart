                ...
                <div className="md:grid md:grid-cols-2 md:mr-15 mr-1 sm:mx-4">
                    ...
                    <div className="mt-5 md:mt-0 md:col-span-1">
                        <div className="md:flex md:flex-col md:justify-center ">
                            ...
                            <p className="self-center mx-8 text-xl font-medium tracking-wide text-justify text-white font- popins">A flat-six engine, also known as a horizontally opposed-six, is a six-cylinder piston engine with three cylinders on each side of a central crankshaft. The most common type of flat-six engine is the boxer-six engine, where each pair of opposed cylinders moves inwards and outwards at the same time.</p>
                            ...
                            <div className="grid justify-center grid-cols-1 gap-6 pb-8 mx-8 md:grid-cols-2 lg:grid-cols-2">
                                <img className="flex p-6 text-6xl rounded-xl h-64 w-64" src="https://storage.echoar.xyz/wispy-violet-4999/90085e7d-85fa-4cb1-abfc-ccabfec9fe96" alt="QR" />
                                <a href="https://go.echoar.xyz/yy5T" target="_blank" rel="noreferrer">
