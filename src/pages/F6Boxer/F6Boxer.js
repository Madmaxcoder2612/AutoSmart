                ...
                <div className="md:grid md:grid-cols-2 md:mr-15 mr-1 sm:mx-4">
                    ...
                    <div className="mt-5 md:mt-0 md:col-span-1">
                        <div className="md:flex md:flex-col md:justify-center ">
                            ...
                            <h2 className="self-center mx-8 mb-4 text-5xl font-medium tracking-wide text-white font-fontVollkorn">F6 Boxer</h2>

                            <p className="self-center mx-8 text-xl font-medium tracking-wide text-justify text-white font-fontVollkorn">A flat-six engine, also known as a horizontally opposed-six, is a six-cylinder piston engine with three cylinders on each side of a central crankshaft. The most common type of flat-six engine is the boxer-six engine, where each pair of opposed cylinders moves inwards and outwards at the same time.</p>
