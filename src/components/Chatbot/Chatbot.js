...
const steps = [
    {
        id: "1",
        message: "Hey! I am Smart bot, how are you feeling today",
        trigger: "expressions",
    },
    {
        id: "expressions",
    ...
    },
    {
        ...
        options: [
            ...
            { value: "Explore 3D Models", label: "Explore 3D Models", trigger: "selectedService" },
    ...
    const handleEnd = ({ steps, values }) => {
        switch (values[values.length - 1]) {
            case "Home":
                history.push("/");
                break;
            case "Explore 3D Models":
                history.push("/models3D");
                break;
            default:
                break;
        }
